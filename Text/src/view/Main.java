...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int count = 1;
            br = new BufferedReader(new FileReader(new File("D:\\LAB\\Text\\src\\model\\input.txt")));
            PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("D:\\LAB\\Text\\src\\model\\output.txt", true)));
            String line;
